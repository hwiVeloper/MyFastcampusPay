...
import com.fastcampuspay.money.query.application.port.out.*;
...
public class DynamoDBAdapter implements GetMoneySumByAddressPort, InsertMoneyIncreaseEventByAddress {
    ...
    private static final String ACCESS_KEY = "AWS_DYNAMODB_ACCESS_KEY";
    private static final String SECRET_KEY = "AWS_DYNAMODB_SECRET_KEY";
