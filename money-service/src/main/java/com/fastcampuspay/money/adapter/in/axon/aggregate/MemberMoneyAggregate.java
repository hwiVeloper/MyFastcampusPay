package com.fastcampuspay.money.adapter.in.axon.aggregate;

import com.fastcampuspay.money.adapter.in.axon.command.IncreaseMemberMoneyCommand;
import com.fastcampuspay.money.adapter.in.axon.command.MemberMoneyCreatedCommand;
import com.fastcampuspay.money.adapter.in.axon.event.IncreaseMemberMoneyEvent;
import com.fastcampuspay.money.adapter.in.axon.event.MemberMoneyCreatedEvent;
import lombok.Data;
...
public class MemberMoneyAggregate {
    ...
    public String handle(@NotNull IncreaseMemberMoneyCommand command) {
        ...
        id = command.getAggregateIndentifier();
